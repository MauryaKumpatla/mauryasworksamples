...
const sections: { heading: string; boxes: { label: string; href: string }[] }[] = [
  { heading: 'AMR Agency', boxes: [{ label: 'AMR Agency Visualizations', href: '/3/data-visualizations/amr-agency' }] },
  { heading: 'Mexico City Capitanes', boxes: [{ label: 'Capitanes Visualizations', href: '/3/data-visualizations/capitanes' }] },
  { heading: 'Personal', boxes: [{ label: 'Personal Visualizations', href: '/3/data-visualizations/personal' }] },
];

export default function DataVisualizations3() {
  return (
    <main style={{
      minHeight: '100vh',
      display: 'flex',
