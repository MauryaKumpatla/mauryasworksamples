  ...
  return (
    <main style={{
      ...
      <article style={{
        ...
        <p><span style={{ textDecoration: 'underline' }}>Note</span>: You may need to double tap twice on hyperlinks depending on mobile device size. One click should suffice across all desktop devices.</p>
