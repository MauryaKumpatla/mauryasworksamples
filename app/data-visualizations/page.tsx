...
const sections: { heading: string; boxes: { label: string; href: string }[] }[] = [
  { heading: 'AMR Agency', boxes: [{ label: 'AMR Agency Visualizations', href: '/data-visualizations/amr-agency' }] },
  { heading: 'Mexico City Capitanes', boxes: [{ label: 'Capitanes Visualizations', href: '/data-visualizations/capitanes' }] },
  { heading: 'Personal', boxes: [{ label: 'Personal Visualizations', href: '/data-visualizations/personal' }] },
];
